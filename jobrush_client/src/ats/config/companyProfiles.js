...
export const MASS_HIRING_PROFILES = [
  ...
  { entity: 'OpenText', type: 'company', role: 'Associate Software Engineer', mandatory_skills: ['Data Structures', 'Algorithms', 'Java', 'SQL'], preferred_skills: ['Python', 'Cloud', 'Agile', 'Git'], education: ['B.Tech', 'B.E.', 'BCA', 'MCA'], weights: { ...DEFAULT_WEIGHTS } },
