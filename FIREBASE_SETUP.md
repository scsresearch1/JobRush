...
2. Select your **JobRush.ai** project (e.g. **jobbrush-f2eb4** — must match all `VITE_FIREBASE_*` values)
...
VITE_FIREBASE_AUTH_DOMAIN=jobbrush-f2eb4.firebaseapp.com
VITE_FIREBASE_PROJECT_ID=jobbrush-f2eb4
VITE_FIREBASE_STORAGE_BUCKET=jobbrush-f2eb4.firebasestorage.app
