...
const generateModernMinimal = (doc, colors, jobRole, jobRoleId) => {
  ...
  doc.text('Generated by JobRush - Your Career Acceleration Platform', 105, 290, { align: 'center' })
}
...
const generateTwoColumn = (doc, colors, jobRole, jobRoleId) => {
  ...
  doc.setFontSize(7)
  doc.setTextColor(128, 128, 128)
  doc.text('Generated by JobRush', 105, 290, { align: 'center' })
}
...
export const generateParsedResumePDF = (parsed) => {
  ...
  for (let p = 1; p <= pageCount; p++) {
    doc.setPage(p)
    doc.text('Generated by JobRush - Your Career Acceleration Platform', 105, doc.internal.pageSize.height - 10, { align: 'center' })
  }
