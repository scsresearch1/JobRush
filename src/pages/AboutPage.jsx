  ...
  <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <nav className="mb-12 sm:mb-16">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-gray-600 hover:text-primary-600 transition font-medium text-sm"
        >
      ...
      <header className="mb-20 sm:mb-28">
        <p className="text-primary-600 font-semibold text-sm uppercase tracking-widest mb-4">About Us</p>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-8">
          <span className="text-gray-900">About </span>
          <span className="gradient-text">JobRush.ai</span>
        </h1>
        <div className="max-w-2xl space-y-6 text-gray-700 text-lg leading-relaxed">
          <p>
      ...
      <section className="mb-24 sm:mb-32">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">What We Deliver</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {DELIVERY_ITEMS.map((item, i) => (
            <div
              key={i}
              className="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:border-primary-100 hover:shadow-xl transition-all duration-300"
            >
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center mb-4 shadow-md">
                <item.icon className="w-5 h-5 text-white" />
              </div>
              <h3 className="text-base font-bold text-gray-900 mb-3 group-hover:text-primary-700 transition-colors">{item.title}</h3>
      ...
      {/* Design Philosophy */}
      <section className="mb-24 sm:mb-32">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-12">Design Philosophy</h2>
        <div className="grid sm:grid-cols-2 gap-4">
          {DESIGN_PRINCIPLES.map((principle, i) => (
            <div
              key={i}
              className="flex gap-4 p-6 rounded-2xl bg-white shadow-md border border-gray-100 hover:border-primary-50 transition-colors"
            >
      ...
      <section className="relative rounded-3xl overflow-hidden mb-20 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 shadow-xl">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_80%_at_50%_120%,rgba(0,0,0,0.1),transparent)]" />
        <div className="relative p-8 sm:p-12 lg:p-16">
          <p className="text-primary-200 text-sm font-semibold uppercase tracking-widest mb-4">Our Differentiator</p>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 max-w-2xl">
            Why JobRush.ai Exists
          </h2>
          <p className="text-lg text-primary-50 leading-relaxed mb-4 max-w-2xl">
      ...
      <div className="text-center">
        <Link
          to="/"
          className="inline-flex items-center gap-2 bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-xl font-semibold transition shadow-lg hover:shadow-xl"
        >
          Get Started
